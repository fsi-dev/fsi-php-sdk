...
class CreateExistingCustomerVirtualAccount implements PayloadInterface
{
    protected $apiKey;
    ...
    public function send(array $formData = [], array $additionalHeaders = []) {
        ...
        try {
            ...
            try {
                ...
                $response = $restAPIHelper->POST($formData, self::$providerBaseURL."/vnubans", $additionalHeaders);
