...
class DeleteBusiness implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [], array $routeParams = [])
    {
        try {
            ...
            $response = $restAPIHelper->DELETE($formData, self::$providerBaseURL."/alatpay-mo/api/v1/merchants/businesses/".$routeParams['businessId'], $additionalHeaders);
