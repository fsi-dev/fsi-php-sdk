...
class TransactionHistories implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [], array $routeParams = [])
    {
        try {
            ...
            $response = $restAPIHelper->POST($formData, self::$providerBaseURL."/account-maintenance/api/AccountMaintenance/CustomerAccount/transhistoryV2", $additionalHeaders);
