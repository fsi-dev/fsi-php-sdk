...
class PerformBulkSettlementAction implements PayloadInterface
{
    protected $apiKey;
    ...
    public function send(array $formData, array $additionalHeaders = [], array $routeParams = []) {
        ...
        try{
            ...
            $response = $restAPIHelper->POST($formData, self::$providerBaseURL."/alatpay-pc/api/v1/paymentCard/settlements/performBulkSettlement", $additionalHeaders);
