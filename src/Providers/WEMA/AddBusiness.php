...
class AddBusiness implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [], array $routeParams = [])
    {
        try {
            ...
            $response = $restAPIHelper->POST($formData, self::$providerBaseURL."/alatpay-mo/api/v1/merchants/".$routeParams['merchantId']."/businesses", $additionalHeaders);
