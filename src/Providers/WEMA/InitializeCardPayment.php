...
class InitializeCardPayment implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [], array $routeParams = []) {
        ...
        try{
            ...
            $response = $restAPIHelper->POST($formData, self::$providerBaseURL."/alatpay-pc/api/v1/paymentCard/mc/initialize", $additionalHeaders);
