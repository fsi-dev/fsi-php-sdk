...
class AuthenticateCallback implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [])
    {
        try{
            ...
            $response = $restAPIHelper->POST($formData, self::$providerBaseURL."/alatpay-pc/api/v1/paymentCard/mc/authenticate/callback", $additionalHeaders);
