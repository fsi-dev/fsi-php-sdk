...
class GetAllBills implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [])
    {
        try{
            ...
            $response = $restAPIHelper->GET($formData, self::$providerBaseURL."/open-bills/api/OpenApiBills/GetAllBills", $additionalHeaders);
