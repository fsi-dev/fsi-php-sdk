...
class GetTransactionDetails implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [], array $routeParams = []) {
        try{
            ...
            if(!array_key_exists("transactionId", $routeParams)){
            ...
            $response = $restAPIHelper->GET($formData, self::$providerBaseURL."/alatpay-pc/api/v1/paymentCard/transactions/".$routeParams['transactionId'], $additionalHeaders);
