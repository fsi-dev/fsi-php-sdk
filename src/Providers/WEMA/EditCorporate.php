...
class EditCorporate implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [], array $routeParam = [])
    {
        try{
            if(!array_key_exists("id", $routeParam)){
            ...
            $response = $restAPIHelper->PATCH($formData, self::$providerBaseURL."/crowdfunding/corporates/".$routeParam['id'], $additionalHeaders);
