...
class VerifyEmail implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [])
    {
        try{
            ...
            $response = $restAPIHelper->POST($formData, self::$providerBaseURL."/crowdfunding/Account/verify/email", $additionalHeaders);
