...
class UpdateMerchant implements PayloadInterface
{
    protected $apiKey;
    ...
    public function send(array $formData, array $additionalHeaders = [], array $routeParams = []) {
        try {
            ...
            $response = $restAPIHelper->PUT($formData, self::$providerBaseURL."/alatpay-mo/api/v1/merchants/".$routeParams['merchantId'], $additionalHeaders);
