...
class GetSettlementRecord implements PayloadInterface
{
    ...
    public function send(array $formData = [], array $additionalHeaders = [], array $routeParams = []) {
        ...
        try{
            ...
            $response = $restAPIHelper->GET($formData, self::$providerBaseURL."/alatpay-pc/api/v1/paymentCard/settlements", $additionalHeaders);
