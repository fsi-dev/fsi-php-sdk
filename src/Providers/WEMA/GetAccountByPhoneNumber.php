...
class GetAccountByPhoneNumber implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [], array $routeParams = [])
    {
        try {
            ...
            if(!array_key_exists("phoneNumber", $routeParams)){
            ...
            $response = $restAPIHelper->GET($formData, self::$providerBaseURL."/account-maintenance/api/AccountMaintenance/CustomerAccount/GetAccountByPhoneNumber/phoneNumber/".$routeParams["phoneNumber"], $additionalHeaders);
