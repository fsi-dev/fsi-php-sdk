...
class GetWemaCorporateAccountDetails implements PayloadInterface
{
    protected $apiKey;
    ...
    public function send(array $formData, array $additionalHeaders = [])
    {
        try{
            ...
            $response = $restAPIHelper->GET($formData, self::$providerBaseURL."/crowdfunding/Verification/corporate/directors", $additionalHeaders);
