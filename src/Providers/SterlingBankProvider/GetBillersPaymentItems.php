...
class GetBillersPaymentItems implements PayloadInterface
{
    /**
     *
     * @var $apiKey
    ...
    public static $providerBaseURL = "api/sterling";
    ...
    public function send(array $formData, array $additionalHeaders = []) {
        ...
        try {
            ...
            try {
                ...
                $response = $restAPIHelper->GET($formData,
                    self::$providerBaseURL."/billpaymentapi/api/Spay/GetBillerPmtItemsRequest", $additionalHeaders);
