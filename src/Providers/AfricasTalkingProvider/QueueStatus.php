...
class QueueStatus implements PayloadInterface
{
    /**
     *
     * @var $apiKey
    ...
    public static $providerBaseURL = "api/".Meta::CURRENT_API_VERSION."/africastalking";
    ...
    public function send(array $formData, array $additionalHeaders = []) {
        ...
        try {
            ...
            try {
                ...
                $response = $restAPIHelper->POST($formData, self::$providerBaseURL."/voice/queueStatus", $additionalHeaders);
