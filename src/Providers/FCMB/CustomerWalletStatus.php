...
class CustomerWalletStatus implements PayloadInterface
{
    protected $apiKey;
    ...
    public function send(array $formData = [], array $additionalHeaders = []) {
        ...
        try {
            ...
            try {
                ...
                $response = $restAPIHelper->PUT($formData, self::$providerBaseURL."/wallet/Customerwallet/Status", $additionalHeaders);
