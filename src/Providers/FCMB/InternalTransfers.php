...
class InternalTransfers  implements PayloadInterface
{
    protected $apiKey;
    ...
    public function send(array $formData = [], array $additionalHeaders = []) {
        ...
        try {
            ...
            try {
                ...
                $response = $restAPIHelper->GET($formData, self::$providerBaseURL."/payments/internal/transfers", $additionalHeaders);
