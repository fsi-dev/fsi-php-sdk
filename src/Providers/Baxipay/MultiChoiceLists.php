...
class MultiChoiceLists implements PayloadInterface
{
    protected $apiKey;
    ...
    public function send(array $formData, array $additionalHeaders = [])
    {
        try {
            ...
            $response = $restAPIHelper->POST($formData, self::$providerBaseURL."/services/multichoice/list", $additionalHeaders);
