...
class ServicesCategory implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [])
    {
        try {
            ...
            $response = $restAPIHelper->POST($formData, self::$providerBaseURL."/billers/services/category", $additionalHeaders);
