...
class ElectricityBillers implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [])
    {
        try {
            ...
            $response = $restAPIHelper->GET($formData, self::$providerBaseURL."/services/electricity/billers", $additionalHeaders);
