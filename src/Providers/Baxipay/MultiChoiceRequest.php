...
class MultiChoiceRequest implements PayloadInterface
{
    ...
    public function send(array $formData, array $additionalHeaders = [])
    {
        try {
            ...
            $response = $restAPIHelper->POST($formData, self::$providerBaseURL."/services/multichoice/request", $additionalHeaders);
